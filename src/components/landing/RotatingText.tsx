...
// CSS import removed to ensure compatibility with mobile browsers that don't support CSS-in-ESM
// Styles are now handled in index.html
      ...
      <AnimatePresence mode={animatePresenceMode} initial={animatePresenceInitial}>
        ...
        >
          {elements.map((wordObj: any, wordIndex: number, array: any[]) => {
            ...
            return (
              <span key={wordIndex} className={cn('text-rotate-word', 'text-rotate-word-container')}>
